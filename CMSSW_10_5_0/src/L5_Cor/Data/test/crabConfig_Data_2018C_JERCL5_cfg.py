...
config.General.requestName = 'crab_L5JERC_SingleMuon_2018C_Autumn18_JECV19'
config.General.workArea = 'crab_L5JERC_SingleMuon_2018C_Autumn18_JECV19'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'JEC_Data_2018C_MINIAOD_cfg.py' 
config.JobType.inputFiles = ['Autumn18_RunC_V19_DATA','Autumn18_V7_MC_SF_AK8PFPuppi.txt','Autumn18_V7_MC_SF_AK4PFchs.txt','Autumn18_V7_MC_PtResolution_AK4PFchs.txt','Autumn18_V7_MC_PtResolution_AK8PFPuppi.txt']
