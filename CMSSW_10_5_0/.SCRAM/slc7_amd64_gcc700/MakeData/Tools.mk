...
ALL_TOOLS      += boost
boost_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/boost/1.67.0/include
...
boost_header_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/boost/1.67.0/include
...
boost_python_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/boost/1.67.0/include
...
cascade_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/cascade/2.2.04-ikaegh/include
...
ALL_TOOLS      += cgal
cgal_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/cgal/4.2-ikaegh/include
...
ALL_TOOLS      += charybdis
charybdis_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/charybdis/1.003-ikaegh/include
...
coral_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/cms/coral/CORAL_2_3_21-dlmfga3/include/LCG
coral_EX_USE := root_cxxdefaults
coral_ORDER := 98000

ALL_TOOLS      += cppunit
cppunit_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/cppunit/1.40.1/include
...
ALL_TOOLS      += cub
cub_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/cub/1.8.0-dlmfga/include
cub_EX_USE := cuda
cub_EX_FLAGS_CXXFLAGS  := -DCUB_STDERR

ALL_TOOLS      += cuda-api-wrappers
cuda-api-wrappers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/cuda-api-wrappers/20180504-dlmfga/include
...
cuda-stubs_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/cuda/10.0.130-dlmfga/include
cuda-stubs_EX_LIB := cuda
cuda-stubs_EX_LIBDIR := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/cuda/10.0.130-dlmfga/lib64/stubs
cuda-stubs_EX_FLAGS_SKIP_TOOL_SYMLINKS  := 1

ALL_TOOLS      += cuda
ALL_LIB_TYPES += CUDA_LIB
cuda_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/cuda/10.0.130-dlmfga/include
...
ALL_TOOLS      += dablooms
dablooms_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/py2-dablooms/0.9.1-ikaegh/include
...
ALL_TOOLS      += dd4hep
dd4hep_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/dd4hep/v01-10x/include
dd4hep_EX_LIB := DDAlign DDCore DDCond DDParsers
dd4hep_EX_USE := root_cxxdefaults root boost xerces-c clhep

ALL_TOOLS      += dire
dire_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/dire/2.003/include
dire_EX_LIB := dire
...
ALL_TOOLS      += eigen
eigen_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/eigen/e4c107b451c52c9ab2d7b7fa4194ee35332916ec/include/eigen3
eigen_EX_FLAGS_CPPDEFINES  := -DEIGEN_DONT_PARALLELIZE

ALL_TOOLS      += evtgen
evtgen_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/evtgen/1.6.0-dlmfga/include
...
ALL_TOOLS      += gbl
gbl_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/gbl/V02-01-03-dlmfga/include
gbl_EX_LIB := GBL
gbl_EX_USE := eigen

ALL_TOOLS      += gcc-analyzer-ccompiler
gcc-analyzer-ccompiler_EX_FLAGS_CFLAGS  := -fplugin=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/gcc-checker-plugin/1.2/lib/libchecker_gccplugins.so -fplugin-arg-libchecker_gccplugins-checkers=all -fsyntax-only

ALL_TOOLS      += gcc-analyzer-cxxcompiler
gcc-analyzer-cxxcompiler_EX_FLAGS_CXXFLAGS  := -fplugin=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/gcc-checker-plugin/1.2/lib/libchecker_gccplugins.so -fplugin-arg-libchecker_gccplugins-checkers=all -fsyntax-only
...
gcc-checker-plugin_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/gcc-checker-plugin/1.2/include
...
gcc-plugin_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/gcc/7.0.0-omkpbe2/lib/gcc/x86_64-unknown-linux-gnu/7.3.1/plugin/include
...
geant4core_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/geant4/10.04-dlmfga/include/Geant4
...
ALL_TOOLS      += geneva
geneva_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/geneva/1.0-RC3-dlmfga/include/Geneva
...
ALL_TOOLS      += hector
hector_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/hector/1.3.4_patch1-dlmfga/include
...
ALL_TOOLS      += heppdt
heppdt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/heppdt/3.03.00-ikaegh2/include
heppdt_EX_LIB := HepPDT HepPID
heppdt_EX_USE := root_cxxdefaults

ALL_TOOLS      += herwig
herwig_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/herwig/6.521-ikaegh/include
herwig_EX_LIB := herwig herwig_dummy
herwig_EX_USE := root_cxxdefaults f77compiler lhapdf photos

ALL_TOOLS      += herwigpp
herwigpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/herwigpp/7.1.4-dlmfga2/include
...
jimmy_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/jimmy/4.2-ikaegh/include
...
ALL_TOOLS      += lhapdf
lhapdf_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/lhapdf/6.2.1-ikaegh/include
...
libjpeg-turbo_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/libjpeg-turbo/2.0.1/include
...
ALL_TOOLS      += libtiff
libtiff_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/libtiff/4.0.3-ikaegh/include
libtiff_EX_LIB := tiff
...
ALL_TOOLS      += libxslt
libxslt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/libxslt/1.1.28-ikaegh/include/libxslt
libxslt_EX_LIB := xslt
...
ALL_TOOLS      += llvm
llvm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/llvm/7.0.0-dlmfga/include
llvm_EX_LIB := clang
...
ALL_TOOLS      += lwtnn
lwtnn_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/lwtnn/2.4-dlmfga/include
lwtnn_EX_LIB := lwtnn
...
ALL_TOOLS      += mctester
mctester_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/mctester/1.25.0a-dlmfga/include
...
numpy-c-api_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/py2-numpy/1.15.1/c-api/core/include
...
py2-pybind11_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/py2-pybind11/2.2.4-ikaegh/include/python2.7
...
ALL_TOOLS      += pythia8
pythia8_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/pythia8/240/include
...
ALL_TOOLS      += qt
qt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/qt/4.8.7-ikaegh/include/QtOpenGL /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/qt/4.8.7-ikaegh/include/QtGui
qt_EX_LIB := QtOpenGL QtGui
qt_EX_USE := root_cxxdefaults qtbase qt3support x11 opengl

ALL_TOOLS      += qt3support
qt3support_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/qt/4.8.7-ikaegh/include/Qt3Support
qt3support_EX_LIB := Qt3Support
qt3support_EX_USE := root_cxxdefaults qtbase
qt3support_EX_FLAGS_CPPDEFINES  := -DQT3_SUPPORT

ALL_TOOLS      += qtbase
qtbase_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/qt/4.8.7-ikaegh/include /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/qt/4.8.7-ikaegh/include/Qt /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/qt/4.8.7-ikaegh/include/QtCore /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/qt/4.8.7-ikaegh/include/QtXml
...
qtdesigner_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/qt/4.8.7-ikaegh/include/QtDesigner
qtdesigner_EX_LIB := QtDesigner
qtdesigner_EX_USE := root_cxxdefaults qtbase qt

ALL_TOOLS      += rivet
rivet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/rivet/2.6.1/include
rivet_EX_LIB := Rivet
...
roofitcore_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/lcg/root/6.12.07-dlmfga/include
...
root_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/lcg/root/6.12.07-dlmfga/include
root_interface_EX_USE := root_cxxdefaults

ALL_TOOLS      += rootcling
rootcling_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/lcg/root/6.12.07-dlmfga/include
...
ALL_TOOLS      += self
self_EX_INCLUDE := /afs/cern.ch/work/c/chatterj/private/JERC_Task_SL7/CMSSW_10_5_0/src /afs/cern.ch/work/c/chatterj/private/JERC_Task_SL7/CMSSW_10_5_0/include/slc7_amd64_gcc700/src /afs/cern.ch/work/c/chatterj/private/JERC_Task_SL7/CMSSW_10_5_0/include/LCG /cvmfs/cms.cern.ch/slc7_amd64_gcc700/cms/cmssw/CMSSW_10_5_0/src /cvmfs/cms.cern.ch/slc7_amd64_gcc700/cms/cmssw/CMSSW_10_5_0/include/slc7_amd64_gcc700/src /cvmfs/cms.cern.ch/slc7_amd64_gcc700/cms/cmssw/CMSSW_10_5_0/include/LCG
self_EX_LIBDIR := /afs/cern.ch/work/c/chatterj/private/JERC_Task_SL7/CMSSW_10_5_0/lib/slc7_amd64_gcc700 /afs/cern.ch/work/c/chatterj/private/JERC_Task_SL7/CMSSW_10_5_0/external/slc7_amd64_gcc700/lib /cvmfs/cms.cern.ch/slc7_amd64_gcc700/cms/cmssw/CMSSW_10_5_0/lib/slc7_amd64_gcc700 /cvmfs/cms.cern.ch/slc7_amd64_gcc700/cms/cmssw/CMSSW_10_5_0/external/slc7_amd64_gcc700/lib
...
ALL_TOOLS      += sherpa
sherpa_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/sherpa/2.2.5-dlmfga/include/SHERPA-MC
...
ALL_TOOLS      += tauolapp
tauolapp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/tauolapp/1.1.5-dlmfga/include
...
ALL_TOOLS      += tbb
tbb_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/tbb/2019_U3/include
tbb_EX_LIB := tbb
...
tensorflow_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/tensorflow/1.6.0-dlmfga/include

ALL_TOOLS      += thepeg
thepeg_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/thepeg/2.1.4-dlmfga2/include
...
tkonlinesw_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/tkonlinesw/4.2.0-1_gcc7-dlmfga/include
...
ALL_TOOLS      += utm
utm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/utm/utm_0.7.1-ikaegh/include
...
vecgeom_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/vecgeom/v00.05.00-dlmfga/include
...
ALL_TOOLS      += vincia
vincia_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/vincia/2.2.04/include
...
ALL_TOOLS      += xrootd
xrootd_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/xrootd/4.8.5/include/xrootd /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/xrootd/4.8.5/include/xrootd/private
xrootd_EX_LIB := XrdUtils XrdClient
xrootd_EX_USE := root_cxxdefaults

ALL_TOOLS      += xtensor
xtensor_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/xtensor/0.17.4/include
xtensor_EX_USE := xtl

ALL_TOOLS      += xtl
xtl_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/xtl/0.4.16/include
...
ALL_TOOLS      += yaml-cpp
yaml-cpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/yaml-cpp/0.6.2-ikaegh/include
yaml-cpp_EX_LIB := yaml-cpp
yaml-cpp_EX_USE := boost

ALL_TOOLS      += yoda
yoda_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/yoda/1.7.4/include
yoda_EX_LIB := YODA
